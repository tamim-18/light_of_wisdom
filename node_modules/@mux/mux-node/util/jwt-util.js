...
exports.pkcs1to8 = exports.toPkcs8Pem = exports.unwrapPem = exports.uint8ArrayToBase64 = exports.base64ToUint8Array = exports.keyFormatErrorMessage = exports.isKeyLike = void 0;
function isKeyLike(key) {
    return typeof key === 'object' && key != null && typeof key.type === 'string';
}
exports.isKeyLike = isKeyLike;
exports.keyFormatErrorMessage = 'Specified signing key must be either a valid PKCS1 or PKCS8 PEM string, a base64 encoded PEM, or an imported key';
