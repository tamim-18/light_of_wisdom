...
export declare class Incidents extends APIResource {
    /**
     ...
     */
    list(query?: IncidentListParams, options?: Core.RequestOptions): Core.PagePromise<IncidentsBasePage, Incident>;
    list(options?: Core.RequestOptions): Core.PagePromise<IncidentsBasePage, Incident>;
    /**
     * Returns all the incidents that seem related to a specific incident.
     */
    listRelated(incidentId: string, query?: IncidentListRelatedParams, options?: Core.RequestOptions): Core.PagePromise<IncidentsBasePage, Incident>;
    listRelated(incidentId: string, options?: Core.RequestOptions): Core.PagePromise<IncidentsBasePage, Incident>;
}
export declare class IncidentsBasePage extends BasePage<Incident> {
}
