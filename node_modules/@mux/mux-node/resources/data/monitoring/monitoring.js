...
const MetricsAPI = __importStar(require("@mux/mux-node/resources/data/monitoring/metrics"));
class Monitoring extends resource_1.APIResource {
    constructor() {
        super(...arguments);
...
(function (Monitoring) {
    Monitoring.Metrics = MetricsAPI.Metrics;
