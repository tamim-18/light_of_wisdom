...
export declare class Dimensions extends APIResource {
    /**
     ...
     */
    listValues(dimensionId: string, query?: DimensionListValuesParams, options?: Core.RequestOptions): Core.PagePromise<DimensionValuesBasePage, DimensionValue>;
    listValues(dimensionId: string, options?: Core.RequestOptions): Core.PagePromise<DimensionValuesBasePage, DimensionValue>;
}
export declare class DimensionValuesBasePage extends BasePage<DimensionValue> {
}
...
export declare namespace DimensionsResponse {
    interface Data {
