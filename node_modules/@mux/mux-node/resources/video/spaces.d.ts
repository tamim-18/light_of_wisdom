...
export declare class Spaces extends APIResource {
     ...
     * We [recommend migrating your application to our partner, LiveKit](https://livekit.io/mux-livekit).
     */
    createBroadcast(spaceId: string, body: SpaceCreateBroadcastParams, options?: Core.RequestOptions): Core.APIPromise<Broadcast>;
    /**
     ...
     * We [recommend migrating your application to our partner, LiveKit](https://livekit.io/mux-livekit).
     */
    deleteBroadcast(spaceId: string, broadcastId: string, options?: Core.RequestOptions): Core.APIPromise<void>;
    /**
     ...
     * We [recommend migrating your application to our partner, LiveKit](https://livekit.io/mux-livekit).
     */
    retrieveBroadcast(spaceId: string, broadcastId: string, options?: Core.RequestOptions): Core.APIPromise<Broadcast>;
    /**
...
export declare class SpacesBasePage extends BasePage<Space> {
}
...
export declare namespace SpaceCreateParams {
    interface Broadcast {
        /**
