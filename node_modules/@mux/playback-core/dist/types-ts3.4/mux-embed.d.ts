declare module 'mux-embed' {
     ...
     */
    export function emit<K extends MuxEvents[keyof MuxEvents] & keyof EventParamsMap>(playerId: PlayerId, type: K, payload?: EventParamsMap[K]): void;
    // Public Utils
    type Headers = {
        'x-cdn': string;
        'content-type': string;
    ...
    type publicUtils = {
        ...
        getComputedStyle<Key extends keyof CSSStyleDeclaration>(el: HTMLElement, prop: Key): ReturnType<CSSStyleDeclaration['getPropertyValue']>;
