      ...
      if (!rangeEntered && this.mediaDuration) {
        ...
        let offRangeHandler = (evt) => {
          ...
          if (evt.target != this && !this.contains(evt.target)) {
            ...
            (_a2 = globalThis.window) == null ? void 0 : _a2.removeEventListener("mousemove", offRangeHandler);
            rangeEntered = false;
            stopTrackingMouse();
          }
        };
        (_a = globalThis.window) == null ? void 0 : _a.addEventListener("mousemove", offRangeHandler, false);
      }
