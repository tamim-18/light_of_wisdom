...
class MediaChromeRange extends import_server_safe_globals.globalThis.HTMLElement {
  ...
  updateSegments(segments) {
    ...
    if (!(segments == null ? void 0 : segments.length))
      return;
    __privateGet(this, _cssRules).activeSegment = (0, import_element_utils.insertCSSRule)(this.shadowRoot, "#segments-clipping rect:nth-child(0)");
    ...
    for (const [i, marker] of normalized.entries()) {
      ...
      const segmentEl = import_server_safe_globals.document.createElementNS("http://www.w3.org/2000/svg", "rect");
      const cssRule = (0, import_element_utils.getOrInsertCSSRule)(this.shadowRoot, `#segments-clipping rect:nth-child(${i + 1})`);
  ...
  getPointerRatio(evt) {
    let pointerRatio = (0, import_element_utils.getPointProgressOnLine)(
      evt.clientX,
      evt.clientY,
