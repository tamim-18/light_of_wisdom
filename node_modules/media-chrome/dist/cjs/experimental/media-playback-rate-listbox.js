...
__export(media_playback_rate_listbox_exports, {
  ...
  MediaPlaybackRateListbox: () => MediaPlaybackRateListbox,
...
class MediaPlaybackRateListbox extends import_media_chrome_listbox.MediaChromeListbox {
  constructor() {
    super();
    __privateAdd(this, _render);
    __privateAdd(this, _onChange);
    __privateAdd(this, _rates, new import_attribute_token_list.AttributeTokenList(this, Attributes.RATES, { defaultValue: import_media_playback_rate_button.DEFAULT_RATES }));
  ...
  get mediaPlaybackRate() {
    return (0, import_element_utils.getNumericAttr)(this, import_constants.MediaUIAttributes.MEDIA_PLAYBACK_RATE, import_media_playback_rate_button.DEFAULT_RATE);
  }
...
render_fn = function() {
  ...
  for (const rate of this.rates) {
    const option = (0, import_media_chrome_listbox.createOption)(
