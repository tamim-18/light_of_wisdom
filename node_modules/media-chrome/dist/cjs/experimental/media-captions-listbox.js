...
__export(media_captions_listbox_exports, {
  MediaCaptionsListbox: () => MediaCaptionsListbox,
...
var import_media_chrome_option = require("./media-chrome-option.js");
...
`;
class MediaCaptionsListbox extends import_media_chrome_listbox.MediaChromeListbox {
  constructor() {
    super({ slotTemplate });
  ...
  get mediaSubtitlesShowing() {
    return getSubtitlesListAttr(this, import_constants.MediaUIAttributes.MEDIA_SUBTITLES_SHOWING);
  }
...
render_fn = function() {
  ...
  const option = (0, import_media_chrome_listbox.createOption)(this.formatOptionText("Off"), "off", isOff);
  option.prepend((0, import_media_chrome_listbox.createIndicator)(this, "select-indicator"));
  container.append(option);
  const subtitlesList = this.mediaSubtitlesList;
  for (const subs of subtitlesList) {
    const option2 = (0, import_media_chrome_listbox.createOption)(
      this.formatOptionText(subs.label, subs),
      (0, import_captions.formatTextTrackObj)(subs),
      this.value == (0, import_captions.formatTextTrackObj)(subs)
    );
    option2.prepend((0, import_media_chrome_listbox.createIndicator)(this, "select-indicator"));
    const type = (_a = subs.kind) != null ? _a : "subs";
    if (type === "captions") {
      option2.append((0, import_media_chrome_listbox.createIndicator)(this, "captions-indicator"));
    }
