...
class MediaChromeMenuButton extends import_media_chrome_button.MediaChromeButton {
  ...
  get invokeTargetElement() {
    ...
    if (this.invokeTarget) {
      return (_a = (0, import_element_utils.getDocumentOrShadowRoot)(this)) == null ? void 0 : _a.querySelector(`#${this.invokeTarget}`);
    }
    return null;
  }
  handleClick() {
...
if (!import_server_safe_globals.globalThis.customElements.get("media-chrome-menu-button")) {
  import_server_safe_globals.globalThis.customElements.define("media-chrome-menu-button", MediaChromeMenuButton);
}
