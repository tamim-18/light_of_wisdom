...
class MediaPlaybackRateMenuButton extends import_media_chrome_menu_button.MediaChromeMenuButton {
  constructor(options = {}) {
    ...
    __privateAdd(this, _rates, new import_attribute_token_list.AttributeTokenList(this, Attributes.RATES, { defaultValue: DEFAULT_RATES }));
  ...
  get mediaPlaybackRate() {
    return (0, import_element_utils.getNumericAttr)(this, import_constants.MediaUIAttributes.MEDIA_PLAYBACK_RATE, DEFAULT_RATE);
  }
