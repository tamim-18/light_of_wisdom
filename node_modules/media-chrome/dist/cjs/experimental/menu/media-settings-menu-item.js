...
template.innerHTML = import_media_chrome_menu_item.MediaChromeMenuItem.template.innerHTML + `
  <style>
...
if (!import_server_safe_globals.globalThis.customElements.get("media-settings-menu-item")) {
  import_server_safe_globals.globalThis.customElements.define("media-settings-menu-item", MediaSettingsMenuItem);
}
