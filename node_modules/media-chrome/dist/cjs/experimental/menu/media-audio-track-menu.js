...
class MediaAudioTrackMenu extends import_media_chrome_menu.MediaChromeMenu {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === import_constants.MediaUIAttributes.MEDIA_AUDIO_TRACK_ENABLED && oldValue !== newValue) {
      ...
      __privateSet(this, _audioTrackList, (0, import_utils.parseAudioTrackList)(newValue));
  ...
  get anchorElement() {
    ...
    return (0, import_element_utils.getMediaController)(this).querySelector("media-audio-track-menu-button");
  }
