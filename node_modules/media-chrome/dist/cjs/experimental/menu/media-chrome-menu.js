...
class MediaChromeMenu extends import_server_safe_globals.globalThis.HTMLElement {
  constructor() {
    ...
    __privateAdd(this, _handleBoundsResize, () => {
      __privateMethod(this, _positionMenu, positionMenu_fn).call(this, false);
...
handleOpen_fn = function() {
  ...
  requestAnimationFrame(() => __privateMethod(this, _positionMenu, positionMenu_fn).call(this, false));
...
resizeMenu_fn = function(animate) {
  ...
  if (expandedSubmenu) {
    ...
    __privateMethod(this, _positionMenu, positionMenu_fn).call(this, animate, width);
  } else {
    this.style.removeProperty("min-width");
    this.style.removeProperty("min-height");
    __privateMethod(this, _positionMenu, positionMenu_fn).call(this, animate);
  }
  style.removeProperty("--media-menu-transition-in");
};
...
backButtonElement_get = function() {
  ...
  return (_a = headerSlot.assignedElements({ flatten: true })) == null ? void 0 : _a.find((el) => el.part.contains("back") && el.part.contains("button"));
};
...
__publicField(MediaChromeMenu, "template", template);
