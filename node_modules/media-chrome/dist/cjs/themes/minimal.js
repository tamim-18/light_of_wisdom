...
module.exports = __toCommonJS(minimal_exports);
...
`;
class MediaThemeMinimal extends import_media_theme_element.MediaThemeElement {
}
__publicField(MediaThemeMinimal, "template", template);
if (!import_server_safe_globals.globalThis.customElements.get("media-theme-minimal")) {
  import_server_safe_globals.globalThis.customElements.define("media-theme-minimal", MediaThemeMinimal);
}
var minimal_default = MediaThemeMinimal;
