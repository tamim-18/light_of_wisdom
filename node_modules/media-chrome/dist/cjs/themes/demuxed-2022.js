...
var demuxed_2022_exports = {};
__export(demuxed_2022_exports, {
  default: () => demuxed_2022_default
});
module.exports = __toCommonJS(demuxed_2022_exports);
...
`;
class MediaThemeDemuxed extends import_media_theme_element.MediaThemeElement {
...
__publicField(MediaThemeDemuxed, "template", template);
__publicField(MediaThemeDemuxed, "observedAttributes", [
  ...import_media_theme_element.MediaThemeElement.observedAttributes,
  "mediastreamtype"
]);
if (!import_server_safe_globals.globalThis.customElements.get("media-theme-demuxed-2022")) {
  import_server_safe_globals.globalThis.customElements.define("media-theme-demuxed-2022", MediaThemeDemuxed);
}
var demuxed_2022_default = MediaThemeDemuxed;
