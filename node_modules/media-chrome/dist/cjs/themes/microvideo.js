...
__export(microvideo_exports, {
  default: () => microvideo_default
});
...
`;
class MediaThemeMicrovideo extends import_media_theme_element.MediaThemeElement {
}
__publicField(MediaThemeMicrovideo, "template", template);
if (!import_server_safe_globals.globalThis.customElements.get("media-theme-microvideo")) {
  import_server_safe_globals.globalThis.customElements.define("media-theme-microvideo", MediaThemeMicrovideo);
}
var microvideo_default = MediaThemeMicrovideo;
