...
var winamp_exports = {};
__export(winamp_exports, {
  default: () => winamp_default
});
module.exports = __toCommonJS(winamp_exports);
...
`;
class MediaThemeWinamp extends import_media_theme_element.MediaThemeElement {
}
__publicField(MediaThemeWinamp, "template", template);
if (!import_server_safe_globals.globalThis.customElements.get("media-theme-winamp")) {
  import_server_safe_globals.globalThis.customElements.define("media-theme-winamp", MediaThemeWinamp);
}
var winamp_default = MediaThemeWinamp;
