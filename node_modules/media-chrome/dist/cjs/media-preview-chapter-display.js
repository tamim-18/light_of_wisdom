...
var _slot;
class MediaPreviewChapterDisplay extends import_media_text_display.default {
  constructor() {
    super();
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === import_constants.MediaUIAttributes.MEDIA_PREVIEW_CHAPTER) {
      if (newValue !== oldValue) {
        if (newValue == null) {
          __privateGet(this, _slot).textContent = "";
...
if (!import_server_safe_globals.globalThis.customElements.get("media-preview-chapter-display")) {
  import_server_safe_globals.globalThis.customElements.define("media-preview-chapter-display", MediaPreviewChapterDisplay);
}
