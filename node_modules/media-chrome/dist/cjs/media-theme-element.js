...
class MediaThemeElement extends import_server_safe_globals.globalThis.HTMLElement {
  constructor() {
    ...
    this.addEventListener(import_constants.MediaStateChangeEvents.BREAKPOINTS_COMPUTED, this.render);
...
__publicField(MediaThemeElement, "processor", import_template_processor.processor);
