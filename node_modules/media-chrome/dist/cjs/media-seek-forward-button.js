...
class MediaSeekForwardButton extends import_media_chrome_button.MediaChromeButton {
  ...
  connectedCallback() {
    this.seekOffset = (0, import_element_utils.getNumericAttr)(this, Attributes.SEEK_OFFSET, DEFAULT_SEEK_OFFSET);
  ...
  set seekOffset(value) {
    ...
    this.setAttribute("aria-label", import_labels.verbs.SEEK_FORWARD_N_SECS({ seekOffset: this.seekOffset }));
